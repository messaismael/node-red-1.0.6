...
RED.palette = (function() {
    ...
    function setLabel(type, el,label, info) {
        ...
        // el.find(".red-ui-palette-port").css({top:(77/2-5)+"px"});
    ...
    function addNodeType(nt,def) {
        ...
        if (exclusion.indexOf(nodeCategory)===-1) {
            ...
            if (def.icon) {
                ...
                iconContainer.css("backgroundColor", RED.utils.getNodeColor(nt,def)).appendTo(d);
                RED.utils.createIconElement(icon_url, iconContainer, true);
            }

            d.css("backgroundColor", "white"/* RED.utils.getNodeColor(nt,def) */);
