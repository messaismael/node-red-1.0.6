            ...
            node.each(function(d,i) {
                    if (d.dirty) {
                        ...
                        if (mouse_mode != RED.state.MOVING_ACTIVE) {
                            ...
                            thisNode.selectAll(".red-ui-flow-node-label").attr("x", function (d) { return 100; });
                            thisNode.selectAll(".red-ui-flow-node-icon-group-right").attr("transform", function(d){return "translate("+(d.w-90)+",0)"});
                            thisNode.selectAll(".red-ui-flow-node-label-right").attr("x", function(d){return d.w-150});
                            ...
                            thisNode.selectAll(".red-ui-flow-node-icon-shade-border").attr("d", function (d) {
                                return "M " + (((!d._def.align && d.inputs !== 0 && d.outputs === 0) || "right" === d._def.align) ? 0 : 90) + " 15 l 0 " + (d.h - 30);
                            });
