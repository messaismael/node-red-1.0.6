        ...
        if (showAllLinkPorts !== -1 || mouse_mode != RED.state.JOINING) {
            ...
            nodeEnter.each(function(d,i) {
                    ...
                    var mainRect = node.append("rect")
                        ...
                        .attr("rx", 5)
                        .attr("ry", 5)
                        .attr("fill", "white"/* function(d) { return RED.utils.getNodeColor(d.type,d._def); /*d._def.color;} */)
                        .on("mouseup",nodeMouseUp)
                        .on("mousedown",nodeMouseDown)
                        .on("touchstart",function(d) {
                            var obj = d3.select(this);
                   ...
                   //node.append("rect").attr("class", "node-gradient-bottom").attr("rx", 6).attr("ry", 6).attr("height",30).attr("stroke","none").attr("fill","url(#gradient-bottom)").style("pointer-events","none");
                    ...
                    if (d._def.icon) {
                        ...
                        var icon_shade_border = icon_group.append("path")
                            .attr("d",function(d) { return "M 90 1 l 0 "+(d.h-2)})
            ...
            node.each(function(d,i) {
                    if (d.dirty) {
                        ...
                        if (mouse_mode != RED.state.MOVING_ACTIVE) {
                            ...
                            thisNode.selectAll(".red-ui-flow-node-label").attr("x", function (d) { return 140; });
                            thisNode.selectAll(".red-ui-flow-node-icon-group-right").attr("transform", function(d){return "translate("+(d.w-115)+",0)"});
                            thisNode.selectAll(".red-ui-flow-node-label-right").attr("x", function(d){return d.w-140});
                            ...
                            thisNode.selectAll(".red-ui-flow-node-icon-shade").attr("height",function(d){return d.h-10;});
                            thisNode.selectAll(".red-ui-flow-node-icon-shade-border").attr("d", function (d) {
                                return "M " + (((!d._def.align && d.inputs !== 0 && d.outputs === 0) || "right" === d._def.align) ? 0 : 115) + " 20 l 0 " + (d.h - 40);
                            });
    ...
    return {
        ...
        gridSize: function(v) {
            if (v === undefined) {
                ...
                console.log("gridSize re",v, Math.max(5,v) )
